...
void test_osijoin_1(CuTest *tc) {
  ...
  eet.size =
      (0 * sizeof(db_eetnode_dbint_t) + 0 * sizeof(db_eetnode_dbstring_t) +
       2 * sizeof(db_eetnode_attr_t) + 1 * sizeof(db_eetnode_t));
  ...
  *(arr_p) = opnode;
  ...
  CuAssertTrue(tc, 1 == init_osijoin(&osijoin, &eet, (db_op_base_t *)&lscan,
                                     (db_op_base_t *)&rscan, &mm));
  init_tuple(&t, osijoin.base.header->tuple_size, osijoin.base.header->num_attr,
             &mm);
  ...
  intResult = getintbypos(&t, 4, osijoin.base.header);
  printf("The db_int value at position %d in the returned tuple is: %d\n", 4,
         intResult);
  CuAssertTrue(tc, 1 == intResult);
  strResult = getstringbypos(&t, 5, osijoin.base.header);
  printf("The string value at position %d in the returned tuple is: %s\n", 5,
         strResult);
  CuAssertTrue(tc, 0 == strcmp(strResult, "Hi"));
  ...
  printf("The db_int value at position %d in the returned tuple is: %d\n", 6,
         intResult);
  CuAssertTrue(tc, 1 == intResult);
  intResult = getintbypos(&t, 7, osijoin.base.header);
  printf("The db_int value at position %d in the returned tuple is: %d\n", 7,
         intResult);
  CuAssertTrue(tc, 0 == intResult);
...
void test_osijoin_2(CuTest *tc) {
  ...
  puts("***********************************************************************"
       "*********");
  puts("Test 2: Join relation 3 with itself, where left's first attribute = "
       "right's third attribute.");
...
void test_osijoin_3(CuTest *tc) {
  ...
  puts("***********************************************************************"
       "*********");
  puts("Test 3: Do a cross product of test_rel3 with itself (join condition is "
       "true).");

  /* Variable delcaration */
  eet.size =
      (1 * sizeof(db_eetnode_dbint_t) + 0 * sizeof(db_eetnode_dbstring_t) +
       0 * sizeof(db_eetnode_attr_t) + 0 * sizeof(db_eetnode_t));
  eet.nodes = malloc((size_t)eet.size);
  eet.stack_size = eet.size;
  arr_p = eet.nodes;
  ...
  *((db_eetnode_dbint_t *)arr_p) = dbintnode;
  ...
  init_scan(&lscan, "test_rel3", &mm);
  init_scan(&rscan, "test_rel3", &mm);
  CuAssertTrue(tc, 0 == init_osijoin(&osijoin, &eet, (db_op_base_t *)&lscan,
                                     (db_op_base_t *)&rscan, &mm));
  init_tuple(&t, osijoin.base.header->tuple_size, osijoin.base.header->num_attr,
             &mm);
...
void test_osijoin_4(CuTest *tc) {
  ...
  puts("***********************************************************************"
       "*********");
  puts(
      "Test 4: Join relation 3 with itself, where the join condition is false");
...
void test_osijoin_5(CuTest *tc) {
  ...
  *((db_eetnode_dbint_t *)arr_p) = dbintnode;
  ...
  CuAssertTrue(tc, 0 == init_osijoin(&osijoin2, &eet, (db_op_base_t *)&rscan,
                                     (db_op_base_t *)&rrscan, &mm));
  CuAssertTrue(tc, 0 == init_osijoin(&osijoin, &eet, (db_op_base_t *)&lscan,
                                     (db_op_base_t *)&osijoin2, &mm));
  init_tuple(&t, osijoin.base.header->tuple_size, osijoin.base.header->num_attr,
             &mm);
  ...
  CuAssertTrue(tc, 0 == intResult);
  intResult = getintbypos(&t, 4, osijoin.base.header);
  printf("The string value at position %d in the returned tuple is: %d\n", 4,
         intResult);
  CuAssertTrue(tc, 1 == intResult);
  strResult = getstringbypos(&t, 5, osijoin.base.header);
  printf("The string value at position %d in the returned tuple is: %s\n", 5,
  ...
  printf("The string value at position %d in the returned tuple is: %d\n", 8,
         intResult);
  CuAssertTrue(tc, 1 == intResult);
  strResult = getstringbypos(&t, 9, osijoin.base.header);
  printf("The string value at position %d in the returned tuple is: %s\n", 9,
         strResult);
  CuAssertTrue(tc, 0 == strcmp(strResult, "Hi"));
  intResult = getintbypos(&t, 10, osijoin.base.header);
  printf("The db_int value at position %d in the returned tuple is: %d\n", 10,
         intResult);
  CuAssertTrue(tc, 1 == intResult);
  intResult = getintbypos(&t, 11, osijoin.base.header);
  printf("The db_int value at position %d in the returned tuple is: %d\n", 11,
         intResult);
  CuAssertTrue(tc, 0 == intResult);
...
void test_osijoin_6(CuTest *tc) {
  ...
  puts("***********************************************************************"
       "*********");
  puts("Test 6: Join fruit_stock_1 with fruit_stock_2 on first attribute of "
       "each.");
...
void test_osijoin_7(CuTest *tc) {
  ...
  puts("***********************************************************************"
       "*********");
  puts(
      "Test 7: Join tenattrtable to tenattrtable on second attribute of each.");
  ...
  *(arr_p) = opnode;
  ...
  init_osijoin(&osijoin, &eet, (db_op_base_t *)&lscan, (db_op_base_t *)&rscan,
               &mm);
  init_tuple(&t, osijoin.base.header->tuple_size, osijoin.base.header->num_attr,
             &mm);
...
void test_osijoin_8(CuTest *tc) {
  ...
  init_scan(&lscan, "test_rel3", &mm);
  init_scan(&rscan, "test_rel3", &mm);
  CuAssertTrue(tc, 0 == init_osijoin(&osijoin, NULL, (db_op_base_t *)&lscan,
                                     (db_op_base_t *)&rscan, &mm));
  init_tuple(&t, osijoin.base.header->tuple_size, osijoin.base.header->num_attr,
             &mm);
...
void test_osijoin_9(CuTest *tc) {
  ...
  puts("***********************************************************************"
       "*********");
  puts("Test 9: Do a cross product of test_rel3 with itself, where there is no "
       "join condition (eet.nodes = NULL).");
