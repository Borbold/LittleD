...
void test_ntjoin_1(CuTest *tc) {
  ...
  *(arr_p) = opnode;
  ...
  init_ntjoin(&ntjoin, &eet, (db_op_base_t *)&lscan, (db_op_base_t *)&rscan,
              &mm);
  init_tuple(&t, ntjoin.base.header->tuple_size, ntjoin.base.header->num_attr,
             &mm);
  ...
  printf("The db_int value at position %d in the returned tuple is: %d\n", 6,
         intResult);
  CuAssertTrue(tc, 1 == intResult);
  intResult = getintbypos(&t, 7, ntjoin.base.header);
  printf("The db_int value at position %d in the returned tuple is: %d\n", 7,
         intResult);
  CuAssertTrue(tc, 0 == intResult);
...
void test_ntjoin_2(CuTest *tc) {
  ...
  puts("***********************************************************************"
       "*********");
  puts("Test 2: Join relaiton 3 with itself, where left's first attribute = "
...
void test_ntjoin_3(CuTest *tc) {
  ...
  *((db_eetnode_dbint_t *)arr_p) = dbintnode;
  ...
  CuAssertTrue(tc, 73 == intResult);
  strResult = getstringbypos(&t, 5, ntjoin.base.header);
  printf("The db_int value at position %d in the returned tuple is: %s\n", 5,
         strResult);
  CuAssertTrue(tc, 0 == strcmp(strResult, "linux"));
...
void test_ntjoin_4(CuTest *tc) {
  ...
  puts("***********************************************************************"
       "*********");
  puts(
      "Test 4: Join relaiton 3 with itself, where the join condition is false");
...
void test_ntjoin_5(CuTest *tc) {
  ...
  *((db_eetnode_dbint_t *)arr_p) = dbintnode;
  ...
  init_ntjoin(&ntjoin2, &eet, (db_op_base_t *)&rscan, (db_op_base_t *)&rrscan,
              &mm);
  init_ntjoin(&ntjoin, &eet, (db_op_base_t *)&lscan, (db_op_base_t *)&ntjoin2,
              &mm);
  init_tuple(&t, ntjoin.base.header->tuple_size, ntjoin.base.header->num_attr,
             &mm);
...
void test_ntjoin_8(CuTest *tc) {
  ...
  init_scan(&lscan, "test_rel3", &mm);
  init_scan(&rscan, "test_rel3", &mm);
  init_ntjoin(&ntjoin, NULL, (db_op_base_t *)&lscan, (db_op_base_t *)&rscan,
              &mm);
  init_tuple(&t, ntjoin.base.header->tuple_size, ntjoin.base.header->num_attr,
             &mm);
